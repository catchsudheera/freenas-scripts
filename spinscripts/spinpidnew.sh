...
LOG=/mnt/p1/z/z/gzip/scripts/spinscripts/spinpid2.log
...
CPU_LOG=/mnt/p1/z/z/gzip/scripts/spinscripts/cpu.log
...
SP=32   #  Setpoint mean drive temperature (C)
